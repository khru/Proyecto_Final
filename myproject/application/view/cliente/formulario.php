	...
	<p>
		...
		<input type="text" name="nombreCorp" size="50" maxlength="100" value="<?php (isset($_POST['nombreCorp'])) ? HelperFunctions::mostrarDatos($data['persona'], 'nombreCorp') : ""; ?>" required autofocus><br>
