...
<h1>Proyecto</h1>
	<form action="<?=URL . $data['destino']?>" method="post">
		...
		<input type="text" name="cliente" value="<?php HelperFunctions::mostrarDatos($data['proyecto'],'cliente')?>"><br/>
		<label for="cliente">Promoción</label><br/>
		<input type="text" name="promocion" value="<?php HelperFunctions::mostrarDatos($data['proyecto'],'promocion')?>"><br/>
		<label for="cliente">Fecha de Inicio</label><br/>
		<input type="date" name="fecha de inicio" value="<?php HelperFunctions::mostrarDatos($data['proyecto'],'fecha de inicio')?>"><br/>
		<label for="cliente">Fecha de Fin</label><br/>
		<input type="date" name="fecha de fin" value="<?php HelperFunctions::mostrarDatos($data['proyecto'],'fecha de fin')?>"><br/>
