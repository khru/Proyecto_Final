...
class ProyectoModel
{
	...
	public static function getSearch($busqueda){
		...
		persona.telefono like :busqueda OR persona.nif like :busqueda OR persona.email like :busqueda OR promocion.codigo like :busqueda OR provincia.nombre like :busqueda OR
